...
class Config(object):
	APP_ID = int(os.environ.get("API_ID", 13323016))
	API_HASH = os.environ.get("API_HASH", "13323016")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6357495710:AAHvAP-BYld8NTCdmvf4gx2ITFLmAJBf-mc")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "dhanus1h_file_store_bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002108819224))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "5798247275"))
	...
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002108819224")
  ...
  # LP_CUSTOM_TEMPLATE= os.environ.get("LP_CUSTOM_TEMPLATE","{file_name} - example \n\n Please Upadate this template acording to you @LazyDeveloperr ")
	...
	AUTO_DELETE_TIME = int(os.environ.get('AUTO_DELETE_TIME', 200000))
...
🧑🏻‍💻 **DΞVΞLФPΞЯ:** [Dhanush](https://t.me/Baby_1143)

👥 **šupp⊕r†:** [Dhanush](https://t.me/Baby_1143)

📢 **Owner:** [Dhanush](https://t.me/Baby_1143)
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 <a href='https://t.me/Baby_1143'>**ミ★- Dhanush -★彡** </a>

<a href=''https://t.me/Baby_1143>ʟᴀᴢʏᴅᴇᴠᴇʟᴏᴘᴇʀ</a> ɪꜱ piro 😎. ᴊᴜꜱᴛ ʟᴇᴀʀɴɪɴɢ ꜰʀᴏᴍ ᴏꜰꜰɪᴄɪᴀʟ ᴅᴏᴄꜱ. ᴘʟᴇᴀꜱᴇ ᴅᴏɴᴀᴛᴇ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴇʀ ꜰᴏʀ ᴋᴇᴇᴘɪɴɢ ᴛʜᴇ ꜱᴇʀᴠɪᴄᴇ ᴀʟɪᴠᴇ.
